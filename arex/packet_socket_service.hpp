...
class packet_socket_service
#if defined(GENERATING_DOCUMENTATION)
  : public boost::asio::io_service::service
#else
  : public boost::asio::detail::service_base<packet_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
private:
  ...
  typedef boost::asio::detail::reactive_socket_service<Protocol> service_impl_type;
...
public:
  ...
  explicit packet_socket_service(boost::asio::io_service& io_service)
    : boost::asio::detail::service_base<
        packet_socket_service<Protocol> >(io_service),
  ...
  void move_assign(implementation_type& impl,
      packet_socket_service& other_service,
      implementation_type& other_impl)
  {
  ...
  {
    if (protocol.type() == SOCK_DGRAM || protocol.type() == SOCK_RAW)
...
#endif // BOOST_ASIO_AREX_PACKET_SOCKET_SERVICE_HPP
